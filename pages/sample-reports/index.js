...
const SampleReportsPage = () => {
    ...
    return (
        <>
            <Head>
                <title>Inspection Reports | Carvohub</title>
                <meta name="description" content="Browse AI-powered car inspection reports. See detailed vehicle assessments with photos, condition ratings, and comprehensive analysis." />
            </Head>
                ...
                <div className="max-w-6xl mx-auto px-4 py-12">
                            ...
                            >
                                ...
                                <div className="px-5 pb-5">
                                    <div className="flex items-center justify-between pt-4 border-t border-gray-100 dark:border-gray-700">
                                        ...
                                        <svg className="w-4 h-4 text-blue-600 dark:text-blue-400 group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    {reports.length === 0 && (
                        <div className="text-center py-16">
                            ...
                            <p className="text-gray-500 dark:text-gray-400">Check back soon for inspection reports.</p>
                        </div>
                    )}
                </div>
            </div>
