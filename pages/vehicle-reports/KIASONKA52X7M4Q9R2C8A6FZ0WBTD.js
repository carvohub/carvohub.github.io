    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-gray-50 dark:bg-gray-950 transition-colors">
                {/* Header */}
                <div className="bg-white dark:bg-gray-950 border-b border-gray-200/50 dark:border-white/5">
...
const Section = ({ title, icon, children }) => (
    <div className="bg-white dark:bg-gray-950 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-800 overflow-hidden mb-6">
        <div className="px-6 py-4 bg-gray-50 dark:bg-gray-900 border-b border-gray-200/50 dark:border-white/5 flex items-center gap-3">
