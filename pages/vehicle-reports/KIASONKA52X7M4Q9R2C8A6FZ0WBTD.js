            ...
            <div className="min-h-screen bg-white dark:bg-gray-950">
                ...
                >
                    ...
                    <div className="absolute inset-0 overflow-hidden">
                        <div className="absolute inset-0 bg-gradient-to-b from-black/60 via-black/40 to-gray-950 z-10" />
                        <img
                            src={carPhotos[0].src}
                ...
                >
                    <div className="max-w-7xl mx-auto px-6">
                        <div className="text-center mb-16">
                            <span className="text-sm font-semibold text-blue-600 dark:text-blue-400 tracking-wider uppercase">Wheels & Tyres</span>
                            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mt-2">
                                Tyre Condition
                            </h2>
                            <p className="text-lg text-gray-600 dark:text-gray-400 mt-4">215/60 R16 Apollo - All matching factory tyres</p>
                        </div>

                        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                            {[
                                { position: "Left Front", image: tyrePhotos.lf },
                                { position: "Right Front", image: tyrePhotos.rf },
                                { position: "Left Rear", image: tyrePhotos.lr },
                                { position: "Right Rear", image: tyrePhotos.rr },
                            ].map((tyre, idx) => (
                                <div key={idx} className="bg-white dark:bg-gray-950 rounded-2xl overflow-hidden border border-gray-200 dark:border-gray-800 hover:shadow-xl transition-all duration-300">
                                    <div className="aspect-square overflow-hidden">
                                        <img src={tyre.image} alt={tyre.position} className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
                                    </div>
                                    <div className="p-4">
                                        <h4 className="font-bold text-gray-900 dark:text-white mb-3">{tyre.position}</h4>
                                        <div className="space-y-2 text-sm">
                                            <div className="flex justify-between">
                                                <span className="text-gray-500">Tread Depth</span>
                                                <span className="font-medium text-gray-900 dark:text-white">1mm</span>
                                            </div>
                                            <div className="flex justify-between">
