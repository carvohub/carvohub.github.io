...
const Footer = () => {
    const footerNavs = [
        {
            label: "Product",
            items: [
                { href: "/vehicle-reports", name: "Vehicle Reports" },
    ...
    return (
        <footer className="border-t border-gray-200/50 dark:border-white/5 bg-gray-50 dark:bg-gray-950">
            <div className="max-w-7xl mx-auto px-6 py-16">
                <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-5">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <div className="mt-6 flex gap-4">
                            <a
                                href="https://twitter.com/carvohub"
                                target="_blank"
                            ...
                            <a
                                href="https://instagram.com/carvohub"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="text-gray-400 dark:text-gray-500 hover:text-blue-500 dark:hover:text-blue-400 transition-colors"
                            ...
                            <a
                                href="https://youtube.com/@carvohub"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="text-gray-400 dark:text-gray-500 hover:text-blue-500 dark:hover:text-blue-400 transition-colors"
                                aria-label="YouTube"
                    ...
                    {footerNavs.map((section, idx) => (
                        <div key={idx}>
                            <h3 className="text-xs font-medium uppercase tracking-widest text-gray-500 dark:text-gray-400 mb-4">
                                {section.label}
                            </h3>
                ...
                {/* Bottom section */}
                <div className="mt-16 pt-8 border-t border-gray-200/50 dark:border-white/5 flex flex-col sm:flex-row justify-between items-center gap-4">
